namespace Stellaris.Data.Variants
{
    ...
    public abstract class VariantBase
    {
        ...
        public bool Is<T>() => this.variant.Is<T>();
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Index == other.Index && this.Get().Equals(other.Get());
        }
